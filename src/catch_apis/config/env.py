...
class ENV:
    ...
    TEST_DATA_PATH: str = os.path.abspath(
        str(os.getenv("TEST_DATA_PATH", "./data/test"))
    )
    ...
    CATCH_LOG_FILE: str = str(
        os.path.abspath(os.getenv("CATCH_LOG_FILE", "./logging/catch.log"))
    )
    CATCH_APIS_LOG_FILE: str = str(
        os.path.abspath(os.getenv("CATCH_APIS_LOG_FILE", "./logging/catch-apis.log"))
    )

    # Numeric properties
    GUNICORN_WORKER_INSTANCES: int = int(os.getenv("GUNICORN_WORKER_INSTANCES", "-1"))
    GUNICORN_FLASK_INSTANCES: int = int(os.getenv("GUNICORN_FLASK_INSTANCES", "-1"))
