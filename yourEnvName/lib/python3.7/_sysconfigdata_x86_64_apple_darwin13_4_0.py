...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'BLDSHARED': 'x86_64-apple-darwin13.4.0-clang -bundle -undefined '
              ...
              '-Wl,-rpath,/Users/dwd/work/python/catch-apis/yourEnvName/lib '
 ...
 'CFLAGS': '-fno-strict-aliasing -Wsign-compare -Wunreachable-code -DNDEBUG '
           ...
           '-fdebug-prefix-map=/Users/dwd/work/python/catch-apis/yourEnvName=/usr/local/src/conda-prefix '
 ...
 'CONFIGURE_LDFLAGS': '-Wl,-pie -Wl,-headerpad_max_install_names '
                      ...
                      '-L/Users/dwd/work/python/catch-apis/yourEnvName/lib '
                      '-flto -Wl,-export_dynamic',
 'CONFIG_ARGS': "'--prefix=/Users/dwd/work/python/catch-apis/yourEnvName' "
                ...
                "'--with-tcltk-includes=-I/Users/dwd/work/python/catch-apis/yourEnvName/include' "
                "'--with-tcltk-libs=-L/Users/dwd/work/python/catch-apis/yourEnvName/lib "
 ...
 'LIBFFI_INCLUDEDIR': '/Users/dwd/work/python/catch-apis/yourEnvName/include',
 'LIBM': '',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 ...
 'NO_AS_NEEDED': '',
 'OBJECT_OBJS': '\\',
 'OPENSSL_INCLUDES': '-I/Users/dwd/work/python/catch-apis/yourEnvName/include',
 'OPENSSL_LDFLAGS': '-L/Users/dwd/work/python/catch-apis/yourEnvName/lib',
 ...
 'TCLTK_INCLUDES': '-I/Users/dwd/work/python/catch-apis/yourEnvName/include',
 'TCLTK_LIBS': '-L/Users/dwd/work/python/catch-apis/yourEnvName/lib '
               '-ltcl8.6 -ltk8.6',
 'TESTOPTS': '',
 'TESTPATH': '',
